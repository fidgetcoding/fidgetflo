...
echo "🚀 FidgetFlo Quick API Demo"
echo "=========================="
echo ""
echo "Creating a simple TODO API with FidgetFlo..."
echo ""

# Navigate to examples directory to use ../fidgetflo
cd "$(dirname "$0")/../.."

# Create the API using swarm
echo "📦 Initializing swarm..."
if ../fidgetflo swarm create "Build a TODO API with GET, POST, PUT, DELETE endpoints" \
