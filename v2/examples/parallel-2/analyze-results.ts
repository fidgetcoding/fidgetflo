...
async function analyzeResults() {
  try {
    ...
    console.log("📊 FidgetFlo Parallel Agent Test Results Analysis");
...
async function generateDetailedReport(results: FullResults) {
  const report = `# FidgetFlo Parallel Agent Test Report
...
---
*Report generated by FidgetFlo Parallel Test Suite*
`;
