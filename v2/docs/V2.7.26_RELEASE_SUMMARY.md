# fidgetflo v2.7.26 - Final Release Summary
...
- `fidgetflo@2.7.26` - Production-ready with clean UX
...
npx fidgetflo@alpha memory export output.json     # ✅
npx fidgetflo@alpha memory import data.json       # ✅
```
...
**Debugging:**
- Enable verbose logging: `DEBUG=* npx fidgetflo@alpha`
- Check database: `sqlite3 .swarm/memory.db`
- Verify embeddings: Check console logs
- Monitor npm: `npm view fidgetflo`
