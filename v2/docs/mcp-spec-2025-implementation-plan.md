# MCP Spec 2025 Implementation Plan for FidgetFlo
...
The upcoming MCP spec introduces **3 major changes** that require updates to FidgetFlo:
...
- **FidgetFlo Issues**: GitHub Issues
