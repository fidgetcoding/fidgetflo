# fidgetflo v2.7.25 Release Notes
...
```bash
npx fidgetflo@alpha memory store "test" "Clean npx experience!"
...
```bash
npm install -g fidgetflo@alpha
fidgetflo memory store "api-design" "REST with JWT auth"
# ✅ Transformer model loads successfully

fidgetflo memory query "authentication patterns"
...
**For Users:**
1. Try npx for quick testing: `npx fidgetflo@alpha memory store "test" "value"`
2. Install globally for semantic search: `npm install -g fidgetflo@alpha`
...
- **Package:** https://www.npmjs.com/package/fidgetflo/v/2.7.25
