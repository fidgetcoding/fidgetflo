...
## Project Overview
This project uses the SPARC (Specification, Pseudocode, Architecture, Refinement, Completion) methodology for systematic Test-Driven Development with AI assistance through FidgetFlo orchestration.
...
### Core SPARC Commands
- `npx fidgetflo@alpha sparc modes`: List all available SPARC development modes
- `npx fidgetflo@alpha sparc run <mode> "<task>"`: Execute specific SPARC mode for a task
- `npx fidgetflo@alpha sparc tdd "<feature>"`: Run complete TDD workflow using SPARC methodology
- `npx fidgetflo@alpha sparc info <mode>`: Get detailed information about a specific mode

### Batchtools Commands (Optimized)
- `npx fidgetflo@alpha sparc batch <modes> "<task>"`: Execute multiple SPARC modes in parallel
- `npx fidgetflo@alpha sparc pipeline "<task>"`: Execute full SPARC pipeline with parallel processing
- `npx fidgetflo@alpha sparc concurrent <mode> "<tasks-file>"`: Process multiple tasks concurrently
...
npx fidgetflo@alpha sparc run spec-pseudocode "Define user authentication requirements" --parallel
```
...
npx fidgetflo@alpha sparc run spec-pseudocode "Create authentication flow pseudocode" --batch-optimize
```
...
npx fidgetflo@alpha sparc run architect "Design authentication service architecture" --parallel
```
...
npx fidgetflo@alpha sparc tdd "implement user authentication system" --batch-tdd
```
...
npx fidgetflo@alpha sparc run integration "integrate authentication with user management" --parallel
```
...
### 🧠 FidgetFlo MCP Tools ONLY Handle:
...
1. **MCP**: `mcp__fidgetflo@alpha__swarm_init` (coordination setup)
2. **MCP**: `mcp__fidgetflo@alpha__agent_spawn` (planning agents)
3. **MCP**: `mcp__fidgetflo@alpha__task_orchestrate` (task coordination)
...
7. **MCP**: `mcp__fidgetflo@alpha__memory_usage` (store results)

**❌ WRONG Workflow:**

1. **MCP**: `mcp__fidgetflo@alpha__terminal_execute` (DON'T DO THIS)
...
[Single Message with BatchTool]:
  ...
  mcp__fidgetflo@alpha__swarm_init { topology: "mesh", maxAgents: 6 }
  mcp__fidgetflo@alpha__agent_spawn { type: "researcher" }
  mcp__fidgetflo@alpha__agent_spawn { type: "coder" }
  mcp__fidgetflo@alpha__agent_spawn { type: "code-analyzer" }
  mcp__fidgetflo@alpha__agent_spawn { type: "tester" }
  mcp__fidgetflo@alpha__agent_spawn { type: "task-orchestrator" }
...
```javascript
Message 1: mcp__fidgetflo@alpha__swarm_init
...
```bash
# Add FidgetFlo MCP server to Claude Code using stdio
claude mcp add fidgetflo@alpha npx fidgetflo@alpha mcp start
```

### 2. Use MCP Tools for Coordination in Claude Code

Once configured, FidgetFlo MCP tools enhance Claude Code's coordination:

**Initialize a swarm:**

- Use the `mcp__fidgetflo@alpha__swarm_init` tool to set up coordination topology
- Choose: mesh, hierarchical, ring, or star
- This creates a coordination framework for Claude Code's work

**Spawn agents:**

- Use `mcp__fidgetflo@alpha__agent_spawn` tool to create specialized coordinators
- Agent types represent different thinking patterns, not actual coders
- They help Claude Code approach problems from different angles

**Orchestrate tasks:**

- Use `mcp__fidgetflo@alpha__task_orchestrate` tool to coordinate complex workflows
...
- `mcp__fidgetflo@alpha__swarm_init` - Set up coordination topology for Claude Code
- `mcp__fidgetflo@alpha__agent_spawn` - Create cognitive patterns to guide Claude Code
- `mcp__fidgetflo@alpha__task_orchestrate` - Break down and coordinate complex tasks

### Monitoring Tools:

- `mcp__fidgetflo@alpha__swarm_status` - Monitor coordination effectiveness
- `mcp__fidgetflo@alpha__agent_list` - View active cognitive patterns
- `mcp__fidgetflo@alpha__agent_metrics` - Track coordination performance
- `mcp__fidgetflo@alpha__task_status` - Check workflow progress
- `mcp__fidgetflo@alpha__task_results` - Review coordination outcomes

### Memory & Neural Tools:

- `mcp__fidgetflo@alpha__memory_usage` - Persistent memory across sessions
- `mcp__fidgetflo@alpha__neural_status` - Neural pattern effectiveness
- `mcp__fidgetflo@alpha__neural_train` - Improve coordination patterns
- `mcp__fidgetflo@alpha__neural_patterns` - Analyze thinking approaches

### GitHub Integration Tools (NEW!):

- `mcp__fidgetflo@alpha__github_swarm` - Create specialized GitHub management swarms
- `mcp__fidgetflo@alpha__repo_analyze` - Deep repository analysis with AI
- `mcp__fidgetflo@alpha__pr_enhance` - AI-powered pull request improvements
- `mcp__fidgetflo@alpha__issue_triage` - Intelligent issue classification
- `mcp__fidgetflo@alpha__code_review` - Automated code review with swarms

### System Tools:

- `mcp__fidgetflo@alpha__benchmark_run` - Measure coordination efficiency
- `mcp__fidgetflo@alpha__features_detect` - Available capabilities
- `mcp__fidgetflo@alpha__swarm_monitor` - Real-time coordination tracking
...
- Tool: `mcp__fidgetflo@alpha__swarm_init`
- Parameters: `{"topology": "mesh", "maxAgents": 5, "strategy": "balanced"}`
- Result: Creates a mesh topology for comprehensive exploration

**Step 2:** Define research perspectives

- Tool: `mcp__fidgetflo@alpha__agent_spawn`
...
- Tool: `mcp__fidgetflo@alpha__task_orchestrate`
...
2. Each agent MUST use FidgetFlo hooks for coordination:
   - `npx fidgetflo@alpha hooks pre-task` before starting
   - `npx fidgetflo@alpha hooks post-edit` after each file operation
   - `npx fidgetflo@alpha hooks notify` to share decisions
...
4. Agents share progress through FidgetFlo memory
...
- Tool: `mcp__fidgetflo@alpha__github_swarm`
...
When using FidgetFlo coordination with Claude Code:
...
FidgetFlo includes powerful hooks that automate coordination:
...
4. **ALL AGENTS MUST USE COORDINATION TOOLS** - Every spawned agent MUST use fidgetflo@alpha hooks and memory

### 🎯 AGENT COUNT CONFIGURATION

**CRITICAL: Dynamic Agent Count Rules**

1. **Check CLI Arguments First**: If user runs `npx fidgetflo@alpha --agents 5`, use 5 agents
...
```javascript
// If CLI args provided: npx fidgetflo@alpha --agents 6
...
npx fidgetflo@alpha hooks pre-task --description "[agent task]" --auto-spawn-agents false
npx fidgetflo@alpha hooks session-restore --session-id "swarm-[id]" --load-memory true
```
...
npx fidgetflo@alpha hooks post-edit --file "[filepath]" --memory-key "swarm/[agent]/[step]"

# Store decisions and findings
npx fidgetflo@alpha hooks notify --message "[what was done]" --telemetry true

# Check coordination with other agents
npx fidgetflo@alpha hooks pre-search --query "[what to check]" --cache-results true
```
...
npx fidgetflo@alpha hooks post-task --task-id "[task]" --analyze-performance true
npx fidgetflo@alpha hooks session-end --export-metrics true --generate-summary true
```
...
1. START: Run `npx fidgetflo@alpha hooks pre-task --description "[your task]"`
2. DURING: After EVERY file operation, run `npx fidgetflo@alpha hooks post-edit --file "[file]" --memory-key "agent/[step]"`
3. MEMORY: Store ALL decisions using `npx fidgetflo@alpha hooks notify --message "[decision]"`
4. END: Run `npx fidgetflo@alpha hooks post-task --task-id "[task]" --analyze-performance true`
...
Message 1: [BatchTool]
  // MCP coordination setup
  - mcp__fidgetflo@alpha__swarm_init
  - mcp__fidgetflo@alpha__agent_spawn (researcher)
  - mcp__fidgetflo@alpha__agent_spawn (coder)
  - mcp__fidgetflo@alpha__agent_spawn (code-analyzer)
  - mcp__fidgetflo@alpha__agent_spawn (tester)
  - mcp__fidgetflo@alpha__agent_spawn (task-orchestrator)
...
[BatchTool]:
  ...
  - mcp__fidgetflo@alpha__agent_spawn { type: "system-architect", name: "System Designer" }
  - mcp__fidgetflo@alpha__agent_spawn { type: "coder", name: "API Developer" }
  - mcp__fidgetflo@alpha__agent_spawn { type: "coder", name: "Frontend Dev" }
  - mcp__fidgetflo@alpha__agent_spawn { type: "code-analyzer", name: "DB Designer" }
  - mcp__fidgetflo@alpha__agent_spawn { type: "tester", name: "QA Engineer" }
  - mcp__fidgetflo@alpha__agent_spawn { type: "researcher", name: "Tech Lead" }
  - mcp__fidgetflo@alpha__agent_spawn { type: "task-orchestrator", name: "PM" }
  - TodoWrite { todos: [multiple todos at once] }

STEP 2: PARALLEL TASK EXECUTION (Single Message!)
[BatchTool]:
  - mcp__fidgetflo@alpha__task_orchestrate { task: "main task", strategy: "parallel" }
  - mcp__fidgetflo@alpha__memory_usage { action: "store", key: "init", value: {...} }
...
[BatchTool - Message 1]:
  ...
  mcp__fidgetflo@alpha__swarm_init { topology: "hierarchical", maxAgents: 8, strategy: "parallel" }
  mcp__fidgetflo@alpha__agent_spawn { type: "system-architect", name: "System Designer" }
  mcp__fidgetflo@alpha__agent_spawn { type: "coder", name: "API Developer" }
  mcp__fidgetflo@alpha__agent_spawn { type: "coder", name: "Auth Expert" }
  mcp__fidgetflo@alpha__agent_spawn { type: "code-analyzer", name: "DB Designer" }
  mcp__fidgetflo@alpha__agent_spawn { type: "tester", name: "Test Engineer" }
  mcp__fidgetflo@alpha__agent_spawn { type: "task-orchestrator", name: "Lead" }
  ...
  // Start orchestration
  mcp__fidgetflo@alpha__task_orchestrate { task: "Build REST API", strategy: "parallel" }

  // Store initial memory
  mcp__fidgetflo@alpha__memory_usage { action: "store", key: "project/init", value: { started: Date.now() } }
...
Message 1: mcp__fidgetflo@alpha__swarm_init
Message 2: mcp__fidgetflo@alpha__agent_spawn (just one agent)
Message 3: mcp__fidgetflo@alpha__agent_spawn (another agent)
Message 4: TodoWrite (single todo)
...
mcp__fidgetflo@alpha__memory_usage
  action: "store"
...
4. **Monitor Progress**: Use mcp**fidgetflo@alpha**swarm_monitor for real-time tracking
...
## FidgetFlo v2.0.0 Features

FidgetFlo extends the base coordination with:
...
Remember: **FidgetFlo coordinates, Claude Code creates!** Start with `mcp__fidgetflo@alpha__swarm_init` to enhance your development workflow.
