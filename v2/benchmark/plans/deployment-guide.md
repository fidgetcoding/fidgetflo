...
setup(
    ...
    version="1.0.0",
    description="Agent swarm benchmarking tool for FidgetFlo",
    long_description=open("README.md").read(),
    long_description_content_type="text/markdown",
    author="FidgetFlo Team",
    author_email="support@fidgetflo.dev",
    url="https://github.com/fidgetflo/swarm-benchmark",
...
license = {text = "MIT"}
authors = [
    {name = "FidgetFlo Team", email = "support@fidgetflo.dev"},
]
...
[project.urls]
Homepage = "https://github.com/fidgetflo/swarm-benchmark"
Documentation = "https://swarm-benchmark.readthedocs.io"
Repository = "https://github.com/fidgetflo/swarm-benchmark"
Issues = "https://github.com/fidgetflo/swarm-benchmark/issues"
```
...
# Install from source
pip install git+https://github.com/fidgetflo/swarm-benchmark.git
```
...
class SwarmBenchmark < Formula
  desc "Agent swarm benchmarking tool for FidgetFlo"
  homepage "https://github.com/fidgetflo/swarm-benchmark"
  url "https://github.com/fidgetflo/swarm-benchmark/archive/v1.0.0.tar.gz"
  sha256 "<hash>"
  license "MIT"
...
```json
{
  ...
  "claude_flow": {
    "endpoint": "https://api.fidgetflo.com",
    "timeout": 300,
    "max_concurrent": 10
  }
}
