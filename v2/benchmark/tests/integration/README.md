# FidgetFlo Integration Tests

This directory contains comprehensive integration tests for benchmarking fidgetflo's SPARC modes and swarm strategies.
...
- fidgetflo installed and accessible
- Non-interactive mode support in fidgetflo