...
- `/workspaces/fidgetflo/v3/mcp/types.ts` - MCP type definitions
- `/workspaces/fidgetflo/v3/mcp/server.ts` - MCP server implementation
- `/workspaces/fidgetflo/v3/mcp/tool-registry.ts` - Tool registration system
- `/workspaces/fidgetflo/CLAUDE.md` - Project documentation
