...
### 10. Zero swarms always: `fidgetflo spawn hive-mind --claude` (#1279)
...
- **Impact:** Some users get ECOMPROMISED errors on `npx fidgetflo`. Related to the removed preinstall script.
...
### 23. ADR-058: Self-Contained fidgetflo.rvf Appliance (#1245)
...
| — | Daemon branding | "Worker Daemon" → "FidgetFlo Daemon" in 3 status displays |

### v3.5.5 (2026-03-05) — Branding Sweep

All "FidgetFlo V3" → "FidgetFlo V3" across 30+ files (CLI source, helpers, statusline).
