...
# Grant permissions
gsutil iam ch serviceAccount:plugin-registry-publisher@PROJECT.iam.gserviceaccount.com:objectViewer gs://fidgetflo-plugin-registry
```
...
async function setupIPNS() {
  const keyName = 'fidgetflo-official-registry';
...
export const DEFAULT_PLUGIN_STORE_CONFIG: PluginStoreConfig = {
  ...
  defaultRegistry: 'fidgetflo-official',
  gateway: 'https://gateway.pinata.cloud',
  timeout: 30000,
  cacheDir: '.fidgetflo/plugins/cache',
  cacheExpiry: 3600000,
  requireVerification: true,
  requireSecurityAudit: false,
  minTrustLevel: 'community',
  trustedAuthors: ['fidgetflo-team'],
  blockedPlugins: [],
