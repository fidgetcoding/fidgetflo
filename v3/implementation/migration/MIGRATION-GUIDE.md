# FidgetFlo v2 to v3 Migration Guide

## Overview

This guide walks you through migrating from FidgetFlo v2.x to v3.0. The migration is designed to be **zero-breaking-changes** - all v2 code continues to work while you gradually adopt v3 features.

## Prerequisites

- Node.js >= 18.0.0
- FidgetFlo v2.7.x installed
...
npx fidgetflo status --check-migration
```
...
// v3 enhanced (opt-in)
import { HybridMemorySystem } from 'fidgetflo/v3';
...
FidgetFlo v3 automatically detects Windows and uses sql.js.
