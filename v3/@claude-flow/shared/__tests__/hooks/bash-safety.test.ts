...
describe('BashSafetyHook', () => {
  ...
  describe('secret detection', () => {
    ...
    it('should detect API key in command', async () => {
      const result = await bashSafety.analyze('curl -H "api_key=GENERIC_KEY_REDACTED-AUDIT-2026-04-25"');
    ...
    it('should detect bearer token', async () => {
      const result = await bashSafety.analyze('curl -H "Authorization: Bearer CURL_AUTH_REDACTED-AUDIT-2026-04-25"');
