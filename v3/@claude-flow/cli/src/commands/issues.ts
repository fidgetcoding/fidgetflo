...
export const issuesCommand: Command = {
  ...
  examples: [
    { command: 'fidgetflo issues list', description: 'List all claims' },
    { command: 'fidgetflo issues claim 123 --agent coder:coder-1', description: 'Claim as agent' },
    { command: 'fidgetflo issues handoff 123 --to agent:tester:tester-1', description: 'Handoff to tester' },
    { command: 'fidgetflo issues stealable', description: 'List stealable' },
    { command: 'fidgetflo issues steal 123 --agent coder:coder-2', description: 'Steal issue' },
    { command: 'fidgetflo issues board', description: 'Visual board' },
  ],
