...
function showHelp(): void {
  console.log(`
Headless Runtime for FidgetFlo V3
...
Environment:
  FIDGETFLO_HEADLESS=true   Enable headless mode
...
async function runBenchmarks(): Promise<BenchmarkResults> {
  console.log('=== FidgetFlo V3 Performance Benchmarks ===\n');
...
async function showStatus(): Promise<void> {
  console.log('=== FidgetFlo V3 System Status ===\n');
  ...
  console.log('\nEnvironment:');
  console.log(`  FIDGETFLO_HEADLESS: ${process.env.FIDGETFLO_HEADLESS || 'not set'}`);
...
async function main(): Promise<void> {
  ...
  process.env.FIDGETFLO_HEADLESS = 'true';
