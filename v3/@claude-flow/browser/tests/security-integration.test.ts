...
describe('BrowserSecurityScanner', () => {
  ...
  describe('scanContent', () => {
    ...
    it('should detect API keys', () => {
      ...
      const result = scanner.scanContent('API Key: GENERIC_KEY_REDACTED-AUDIT-2026-04-25');
  ...
  describe('maskPII', () => {
    ...
    it('should mask API keys', () => {
      const result = scanner.maskPII('STRIPE_TOKEN_REDACTED-AUDIT-2026-04-25', 'api-key');
