...
### Check Claim
```bash
npx fidgetflo claims check --agent agent-123 --claim write
```

### Grant Claim
```bash
npx fidgetflo claims grant --agent agent-123 --claim write --scope "/src/**"
```

### Revoke Claim
```bash
npx fidgetflo claims revoke --agent agent-123 --claim write
```

### List Claims
```bash
npx fidgetflo claims list --agent agent-123
```
