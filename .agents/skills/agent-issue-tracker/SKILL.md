...
tools: mcp__fidgetflo__swarm_init, mcp__fidgetflo__agent_spawn, mcp__fidgetflo__task_orchestrate, mcp__fidgetflo__memory_usage, Bash, TodoWrite, Read, Write
color: green
type: development
capabilities:
...
[Single Message - Issue Lifecycle Management]:
  ...
  mcp__fidgetflo__agent_spawn { type: "coordinator", name: "Issue Manager" }
  mcp__fidgetflo__agent_spawn { type: "analyst", name: "Progress Tracker" }
  mcp__fidgetflo__agent_spawn { type: "researcher", name: "Context Gatherer" }
