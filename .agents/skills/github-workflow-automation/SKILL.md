...
```bash
# Usage example
npx fidgetflo@alpha github gh-coordinator \
...
npx fidgetflo@alpha github repo-architect \
...
npx fidgetflo@alpha github ci-orchestrator \
...
mcp__fidgetflo__agent_spawn { type: "analyst", name: "Security Analyst" }
...
npx fidgetflo@alpha hooks notify \
...
npx fidgetflo@alpha github sync-coordinator \
...
- [ ] `fidgetflo@alpha` package available
...
- **FidgetFlo**: https:/$github.com$ruvnet$fidgetflo
