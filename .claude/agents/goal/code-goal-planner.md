...
npx fidgetflo sparc run spec-pseudocode "OAuth2 authentication system"
npx fidgetflo sparc run architect "microservices communication layer"
npx fidgetflo sparc tdd "payment processing feature"
npx fidgetflo sparc pipeline "complete feature implementation"

# Batch processing for complex goals
npx fidgetflo sparc batch spec,arch,refine "user management system"
npx fidgetflo sparc concurrent tdd tasks.json
```
...
sparc_phases:
  specification:
    command: "npx fidgetflo sparc run spec-pseudocode 'payment processing'"
    deliverables:
      - requirements_doc
      - acceptance_criteria
      - test_scenarios
  ...
  pseudocode:
    command: "npx fidgetflo sparc run pseudocode 'payment flow algorithms'"
    deliverables:
      - payment_flow_logic
  ...
  architecture:
    command: "npx fidgetflo sparc run architect 'payment system design'"
    deliverables:
      - system_components
      - api_contracts
      - database_schema
  ...
  refinement:
    command: "npx fidgetflo sparc tdd 'payment feature'"
    deliverables:
      - unit_tests
      - integration_tests
  ...
  completion:
    command: "npx fidgetflo sparc run integration 'deploy payment system'"
    deliverables:
      - deployed_system
      - documentation
      - monitoring_setup
...
npx fidgetflo sparc run spec-pseudocode "user authentication feature"

# 2. Execute architecture phase
npx fidgetflo sparc run architect "authentication system design"

# 3. TDD implementation with goal tracking
npx fidgetflo sparc tdd "authentication feature" --track-goals

# 4. Complete integration with goal validation
npx fidgetflo sparc run integration "deploy authentication" --validate-goals

# 5. Verify goal achievement
npx fidgetflo sparc verify "authentication feature complete"
```
