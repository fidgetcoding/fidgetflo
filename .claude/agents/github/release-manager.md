...
mcp__fidgetflo__agent_spawn { type: "coordinator", name: "Release Coordinator" }
...
[Single Message - Complete Release Management]:
  ...
  mcp__fidgetflo__swarm_init { topology: "star", maxAgents: 8 }
  mcp__fidgetflo__agent_spawn { type: "coordinator", name: "Release Director" }
  mcp__fidgetflo__agent_spawn { type: "tester", name: "QA Lead" }
  mcp__fidgetflo__agent_spawn { type: "reviewer", name: "Senior Reviewer" }
  mcp__fidgetflo__agent_spawn { type: "coder", name: "Version Controller" }
  mcp__fidgetflo__agent_spawn { type: "analyst", name: "Performance Analyst" }
  ...
  release-validation:
    ...
    steps:
      ...
      - name: Validate Release
        run: npx fidgetflo release validate
```
