...
tools: mcp__github__push_files, mcp__github__create_or_update_file, mcp__github__get_file_contents, mcp__github__create_pull_request, mcp__github__search_repositories, mcp__github__list_repositories, mcp__fidgetflo__swarm_init, mcp__fidgetflo__agent_spawn, mcp__fidgetflo__task_orchestrate, mcp__fidgetflo__memory_usage, mcp__fidgetflo__coordination_sync, mcp__fidgetflo__load_balance, TodoWrite, TodoRead, Bash, Read, Write, Edit, MultiEdit
---
