...
```
Tool: mcp__fidgetflo__neural_status
Result: {
  "patterns": {
    "convergent": 0.92,
    "divergent": 0.87,
...
## Pattern Analysis
```
Tool: mcp__fidgetflo__neural_patterns
Parameters: {
  "action": "analyze",
...
npx fidgetflo neural train --type coordination --epochs 50

# Check neural status
npx fidgetflo neural status

# Analyze patterns
npx fidgetflo neural patterns --analyze
```