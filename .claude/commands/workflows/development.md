...
### 4. Monitor Progress
```
Tool: mcp__fidgetflo__task_status
...
npx fidgetflo workflow dev "REST API with auth"

# Create custom workflow
npx fidgetflo workflow create --name "api-dev" --steps "design,implement,test,deploy"

# Execute saved workflow
npx fidgetflo workflow execute api-dev
```