...
```bash
# Test pre-edit hook
npx fidgetflo hook pre-edit --file test.js

# Test session summary
npx fidgetflo hook session-end --summary
```
    ...
    "PreToolUse": [
      {
        ...
        "hooks": [{
          "type": "command",
          "command": "npx fidgetflo hook pre-write --file '${tool.params.file_path}'"
        }]
      }
    ]
  }
...
# Test specific hook
npx fidgetflo hook pre-edit --file app.js --debug
```
