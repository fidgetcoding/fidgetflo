...
npx fidgetflo sparc run architect "design microservices"

# 2. Implementation
npx fidgetflo sparc run coder "implement services"

# 3. Testing
npx fidgetflo sparc run tdd "test all services"

# 4. Review
npx fidgetflo sparc run reviewer "review implementation"
```
...
```bash
# 1. Research phase
npx fidgetflo sparc run researcher "research best practices"

# 2. Innovation
npx fidgetflo sparc run innovator "propose novel solutions"

# 3. Documentation
npx fidgetflo sparc run documenter "document findings"
```
