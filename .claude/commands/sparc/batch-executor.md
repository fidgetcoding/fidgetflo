...
npx fidgetflo sparc run batch-executor "process multiple files"

# For alpha features
npx fidgetflo@alpha sparc run batch-executor "process multiple files"
```

### Option 3: Local Installation
```bash
# If fidgetflo is installed locally
./fidgetflo sparc run batch-executor "process multiple files"
```
