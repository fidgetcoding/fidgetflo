...
npx fidgetflo sparc run analyzer "analyze codebase performance"

# For alpha features
npx fidgetflo@alpha sparc run analyzer "analyze codebase performance"
```

### Option 3: Local Installation
```bash
# If fidgetflo is installed locally
./fidgetflo sparc run analyzer "analyze codebase performance"
```
