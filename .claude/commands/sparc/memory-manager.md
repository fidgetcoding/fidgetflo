...
npx fidgetflo sparc run memory-manager "organize project knowledge"

# For alpha features
npx fidgetflo@alpha sparc run memory-manager "organize project knowledge"
```

### Option 3: Local Installation
```bash
# If fidgetflo is installed locally
./fidgetflo sparc run memory-manager "organize project knowledge"
```
