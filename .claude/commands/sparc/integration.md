...
npx fidgetflo sparc run integration "connect payment service"

# For alpha features
npx fidgetflo@alpha sparc run integration "connect payment service"

# With namespace
npx fidgetflo sparc run integration "your task" --namespace integration

# Non-interactive mode
npx fidgetflo sparc run integration "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If fidgetflo is installed locally
./fidgetflo sparc run integration "connect payment service"
```
...
```bash
# Store mode-specific context
npx fidgetflo memory store "integration_context" "important decisions" --namespace integration

# Query previous work
npx fidgetflo memory query "integration" --limit 5
```
