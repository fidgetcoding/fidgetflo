...
npx fidgetflo sparc run spec-pseudocode "define payment flow requirements"

# For alpha features
npx fidgetflo@alpha sparc run spec-pseudocode "define payment flow requirements"

# With namespace
npx fidgetflo sparc run spec-pseudocode "your task" --namespace spec-pseudocode

# Non-interactive mode
npx fidgetflo sparc run spec-pseudocode "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If fidgetflo is installed locally
./fidgetflo sparc run spec-pseudocode "define payment flow requirements"
```
...
```bash
# Store mode-specific context
npx fidgetflo memory store "spec-pseudocode_context" "important decisions" --namespace spec-pseudocode

# Query previous work
npx fidgetflo memory query "spec-pseudocode" --limit 5
```
