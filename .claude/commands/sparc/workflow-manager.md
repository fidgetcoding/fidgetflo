...
npx fidgetflo sparc run workflow-manager "automate deployment"

# For alpha features
npx fidgetflo@alpha sparc run workflow-manager "automate deployment"
```

### Option 3: Local Installation
```bash
# If fidgetflo is installed locally
./fidgetflo sparc run workflow-manager "automate deployment"
```
